 ...
 */
 ...
 add_action( 'add_meta_boxes', 'pkt_add_custom_box' );
/**
 * Add Meta Boxes.
 */ 
function pkt_add_custom_box() {
	// Adding layout meta box for page
	add_meta_box( 'page-layout', __( 'Select Layout', 'pkt' ), 'pkt_page_layout', 'page', 'side', 'default' ); 
	// Adding layout meta box for
	add_meta_box( 'page-layout', __( 'Select Layout', 'pkt' ), 'pkt_page_layout', 'post', 'side', 'default' ); 
}
...
$page_layout = array(
							'default-layout' 	=> array(
														...
														'label' 		=> __( 'Default Layout', 'pkt' )
														),
							'right-sidebar' 	=> array(
														'id'			=> 'pkt_page_layout',
														'value' 		=> 'right_sidebar',
														'label' 		=> __( 'Right Sidebar', 'pkt' )
														),
							'left-sidebar' 	=> array(
														'id'			=> 'pkt_page_layout',
														'value' 		=> 'left_sidebar',
														'label' 		=> __( 'Left Sidebar', 'pkt' )
														),
							'no-sidebar-full-width' => array(
															'id'			=> 'pkt_page_layout',
															'value' 		=> 'no_sidebar_full_width',
															'label' 		=> __( 'No Sidebar Full Width', 'pkt' )
															),
							'no-sidebar-content-centered' => array(
															'id'			=> 'pkt_page_layout',
															'value' 		=> 'no_sidebar_content_centered',
															'label' 		=> __( 'No Sidebar Content Centered', 'pkt' )
															)
						);
...
add_action('pre_post_update', 'pkt_save_custom_meta'); 
/**
 * save the custom metabox data
 * @hooked to pre_post_update hook
 */
function pkt_save_custom_meta( $post_id ) { 
	global $page_layout, $post; 
